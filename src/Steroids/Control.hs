...
applySettings rsettings msettings tinfos =
  (flip Map.map) tinfos $ \tinfo -> let rinfo = rsettings tinfo
                                        mname = msettings rinfo
                                    in (tinfo, rinfo, mname)

defaultRecordSettings
  :: (HasCallStack)
  => (TableInfo -> ColInfo -> FieldInfo)
  -> TableInfo
  -> Types.RecordInfo
defaultRecordSettings colSettings tinfo@TableInfo{..} = Types.RecordInfo
...
defaultFieldSettings
  ...
  -> ColInfo
  -> FieldInfo
defaultFieldSettings TableInfo{..} cinfo@ColInfo{..} = FieldInfo
...
defaultModuleSettings
  ...
  => RecordInfo
  -> ModuleName
defaultModuleSettings rinfo = ModuleName ([qc|AutoGenerated.Models.{recordHaskellReadTypeName rinfo}|])
...
getDefaultHaskellType
  ...
  => ColInfo
  -> QualifiedType
getDefaultHaskellType cinfo@ColInfo{colRawPGType=(ColType ctype)} = case ctype of
